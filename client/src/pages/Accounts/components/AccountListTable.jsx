...
import {
  ACCOUNT_LIST_TABLE_HEADERS as tableHeaders,
        ...
        <TableBody>
          {rows.map(row => (
            <TableRow key={row.uuid}>
              ...
              <TableCell align="center" sx={{ color: `${getIsProfit(row.assets, row.payments)}` }}>
                {getAssetPattern(row.assets)}
              </TableCell>
